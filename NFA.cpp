...
NFA::NFA() : numStates(0) {} // Constructor initializing the number of states
...
set<int> NFA::kleeneClosure(const set<int> &states)
{
...
set<int> NFA::positiveClosure(const set<int> &states)
{
...
set<int> NFA::setUnion(const set<int> &set1, const set<int> &set2)
{
    set<int> result = set1;
...
unordered_map<int, int> NFA::getStatePriorities() const
{
    return statePriorities;
}

unordered_map<int, string> NFA::getPriorityStrings() const
{
    return priorityStrings;
}

set<char> NFA::getPunctuations() const
{
    return punctuations;
}

// Helper function to update the number of states
void NFA::updateNumStates(int from, int to)
{
